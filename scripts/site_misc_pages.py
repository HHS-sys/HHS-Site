...
def contact_page(*, SERVICES, SERVICE_DISPLAY_ORDER, hero, PHONE_LINK, PHONE_DISPLAY, EMAIL, section_heading, page) -> str:
    ...
    return page("Contact Hekman Home Services | Request a Quote", "Contact Hekman Home Services Inc. for renovation and repair projects in London, Ontario. Call 519-808-3312 or prepare a quote request by email.", "/contact/", "project-129.jpg", "contact", body, "contact-page", image_alt="Completed London kitchen renovation with an island and pendant lighting")
