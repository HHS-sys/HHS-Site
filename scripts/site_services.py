...
SERVICES: dict[str, dict] = {
    ...
    "water-damage": {
        ...
        "hero": "salon-after-1.jpg",
        "hero_alt": "Anonymous London salon returned to a bright working finish after restorative repairs",
        "position": "50% 45%",
    ...
    "commercial": {
        ...
        "gallery": [
            ("salon-after-1.jpg", "Completed anonymous London salon interior", "Salon commercial restoration"),
...
SERVICE_CARD_VARIANTS: dict[str, list[tuple[str, str]]] = {
    ...
    "water-damage": [
        ("salon-after-1.jpg", "Working salon interior after restorative repairs"),
