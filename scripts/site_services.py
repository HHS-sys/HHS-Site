...
SERVICES: dict[str, dict] = {
    "bathrooms": {
        ...
        "hero_alt": "Completed bathroom renovation with a tiled glass shower enclosure",
        "position": "50% 52%",
    ...
    "handyman-repairs": {
        ...
        "gallery": [
            ...
            ("project-140.jpg", "Interior closet shelving and hanging rod being installed", "Closet storage installation"),
...
SERVICE_CARD_VARIANTS: dict[str, list[tuple[str, str]]] = {
    ...
    "kitchens": [
        ...
        ("hilltop-kitchen-angle.jpg", "Completed Hilltop kitchen viewed across the island"),
        ("kitchenette-after-wide.jpg", "Completed office kitchen with new cabinetry and counter"),
        ("hyde-park-kitchen-after.jpg", "Completed Hyde Park kitchen with refaced cabinetry, counters and backsplash"),
    ...
    "basements": [
        ...
        ("pond-mills-basement-floor-installation.jpg", "Plank flooring installation in the Pond Mills lower level"),
    ...
    "water-damage": [
        ...
        ("blackfriars-investigation.jpg", "Blackfriars ceiling opened during leak investigation"),
